========================================================================
    WIN32-ANWENDUNG: jhlabs-Projektübersicht
========================================================================

Diese jhlabs-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre jhlabs-Anwendung besteht.
...
jhlabs.ico
    ...
    Dieses Symbol ist in der Hauptressourcendatei "jhlabs.rc" 
    enthalten.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "jhlabs.pch und eine 
