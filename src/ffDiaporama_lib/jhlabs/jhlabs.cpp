// jhlabs.cpp : Definiert den Einstiegspunkt für die Anwendung.
//

#include "stdafx.h"
#include "jhlabs.h"
//#include "image/AbstractBufferedImageOp.h"
#include "image/ConvolveFilter.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_JHLABS, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_JHLABS));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_JHLABS));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_JHLABS);
