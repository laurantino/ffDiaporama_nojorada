...
{
   Q_OBJECT
      bool bBrowserInitialised;
      bool bBrowserstopped;
      QFutureWatcher<void> ThreadPreload;
      bool bStopPreloader;
      void startPreloading();
      void stopPreloading();
      autoTimer* load_timer =0;
      wgt_QVideoPlayer* currentPlayer = { 0 };
public:
    ...
    QFileInfoList           FileInfoList, MusicFileInfoList; // used in dragdrop
    ...
    void AdjustRuler(int CurIndex=-1);
    void CheckVersion();
...
private slots:
    ...
    void DoAddFile();
    void DoAddFFDFile(const QString filename);
    ...
    void DoSaveFile();
    void makeBackup(const QString Filename);
...
private:
    ...
    Ui::MainWindow *ui;
    TResKeyList ResKeyList;     // Ressource key mapping table
