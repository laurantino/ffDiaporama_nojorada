...
bool wgt_QMultimediaBrowser::setThreadToWait() { return ui->FolderTable->setThreadToWait(); }
void wgt_QMultimediaBrowser::setThreadResume() { ui->FolderTable->setThreadResume(); }
