...
public:
    ...
    explicit                MediaFileItem(cBaseMediaFile *MediaFileObject);
                            ~MediaFileItem() {}
   //MediaFileItem() = delete;
   //MediaFileItem(MediaFileItem const&) = delete;
   //MediaFileItem& operator=(MediaFileItem const&) = delete;
   //MediaFileItem(MediaFileItem&&) = delete;
   //MediaFileItem& operator=(MediaFileItem&&) = delete;
...
signals:
    ...
    void                    RenameFiles();
    void                    Refresh();
    void callUpdate(const QModelIndex& index);

public slots:
    void                    DoResizeColumns();
    void                    s_ContextMenu(const QPoint Point);
    void                    s_Browser_Properties();
    void onCcallUpdate(const QModelIndex& index) { update(index); }
